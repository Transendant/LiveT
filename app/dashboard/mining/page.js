        ...
        <main className="bg-[#1b1a1f] grid xl:grid-cols-[20%_80%] w-full text-[#f2f2f2]">
          ...
          <section className="py-6 px-5 lg:py-10 lg:px-[72px]">
            ...
            <section className="lg:pt-16 flex flex-col">
              ...
              {/* Info alert */}
              {miningshowshow && miningshowshow == "i" && (
              ...
              <article>
                ...
                <article className="grid gap-4 pt-4 lg:grid-cols-3 lg:gap-8">
                  ...
                  <article className="bg-[#0a0a0a] border border-[#292929] shadow-sm rounded-[12px] p-4 lg:p-6">
                    <p className="text-[#c4c4c4] text-[12px] lg:text-[16px] font-meidum leading-[119.2%]">
                      Mining deposit (current plan)
                    </p>
                    <p className="text-[#c4c4c4] text-[20px] lg:text-[24px] font-semibold leading-[150%] pt-[10px]">
                      {user &&
                        user.mining.plan.toLocaleString("en-US", {
                          style: "currency",
                          currency: "USD",
                          minimumFractionDigits: 2,
                        })}
                  ...
                  <article className="bg-[#0a0a0a] border border-[#292929] shadow-sm rounded-[12px] p-4 lg:p-6">
                    ...
                    <p className="text-[#c4c4c4] text-[20px] lg:text-[24px] font-semibold leading-[150%] pt-[10px]">
                      {user &&
                        user.mining.gains.toLocaleString("en-US", {
                          style: "currency",
                          currency: "USD",
                          minimumFractionDigits: 2,
                        })}
            ...
            <div id="transactions" class="pt-16 pb-24 lg:py-24">
              ...
              <h2 class="text-[24px] mb-6 font-semibold hidden lg:block">
                Mining Transaction History ({txns ? txns.length : "0"})
              </h2>
